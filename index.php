...
<head>
  ...
  <style>
      ...
      .nav-sidebar .nav-item:hover>.nav-link, .nav-sidebar .nav-item>.nav-link.active {
      ...
      .nav-sidebar .nav-item:hover>.nav-link>i, .nav-sidebar .nav-item>.nav-link.active>i {
          color: #2563eb !important;
      }
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item"><a href="?page=jasa" class="nav-link"><i class="fas fa-university nav-icon"></i> <p>Jasa</p></a></li> 
          ...
          <li class="nav-item"><a href="?page=jadwal" class="nav-link"><i class="nav-icon far fa-clock"></i> <p>Jadwal</p></a></li> 
          <li class="nav-item"><a href="?page=absen" class="nav-link"><i class="nav-icon fas fa-user-check"></i> <p>Absensi Karyawan</p></a></li> 
          <li class="nav-item"><a href="?page=payroll" class="nav-link"><i class="nav-icon fas fa-money-bill-wave"></i> <p>Payroll</p></a></li> 
          <li class="nav-item"><a href="?page=generate&aksi=tarik" class="nav-link"><i class="nav-icon fas fa-download"></i> <p>Tarik Data</p></a></li> 
          <li class="nav-item"><a href="?page=denda" class="nav-link"><i class="nav-icon fas fa-exclamation-triangle"></i> <p>Denda</p></a></li> 
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item"><a href="?page=rkk" class="nav-link"><i class="far fa-calendar-plus nav-icon"></i> <p>Rencana Upah</p></a></li> 
              <li class="nav-item"><a href="?page=realisasi" class="nav-link"><i class="fas fa-check-double nav-icon"></i> <p>Realisasi Upah</p></a></li> 
              <li class="nav-item"><a href="?page=realisasi&aksi=karyawan" class="nav-link"><i class="fas fa-file-invoice-dollar nav-icon"></i> <p>Cetak Slip</p></a></li> 
            </ul>
          </li>
