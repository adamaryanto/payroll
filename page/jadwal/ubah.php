...
$simpan = @$_POST ['simpan'];
if($simpan) {
$sql = $koneksi->query("update tb_jadwal set keterangan = '$tketerangan' , jam_masuk ='$tjammasuk' , jam_keluar ='$tjamkeluar' , istirahat_masuk ='$tistirahatmasuk' , istirahat_keluar = '$tistirahatkeluar' where id_jadwal = '$idjadwal' ");
if($sql) {
        ?>
