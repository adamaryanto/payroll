...
if($_SESSION['level'] !="OWNER"){$level =  "Hidden"  ;}else{$level="";}
if($_SESSION['level'] =="OWNER"){$hr =  "Hidden"  ;}else{$hr="";}
...
$no = 1;
    ...
    {
      if($data['status_rkk']=="1"){$a = "#FFEBCD"; $pro="hidden";$app="";$unpro="";$unapp="hidden";}
      elseif($data['status_rkk']=="2"){$a = "#F0FFFF"; $pro="hidden";$app="hidden";$unpro="hidden";$unapp="";}
      elseif($data['status_rkk']=="0"){$a = "transparent";$app="hidden";$pro="";$unpro="hidden";$unapp="hidden";}
      elseif($data['status_rkk']=="3"){$a = "#98FB98"; $pro="hidden";$app="hidden";$unpro="hidden";$unapp="hidden";}
      else{}
