            ...
            <div class="box-header with-border" style=" background-color:#5F9EA0; border:1px ; color:white; ">
                ...
                <form method="POST" enctype="multipart/form-data">
                    <div class="panel-body">
                        <div class="row" style="background-color:white; padding: 15px 0; margin-bottom: 10px;">
                            <div class="col-md-6">
                                <a href="?page=rkk&aksi=tambah" class="btn btn-info" style="border-radius: 4px;">
                                    <i class="fa fa-plus-circle"></i> &nbsp;Tambah Data Rencana Upah
                                </a>
                            </div>
                        </div>
                    </div>
