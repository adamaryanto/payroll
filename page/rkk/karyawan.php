...
<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 mt-10 mb-10">
    <div class="bg-white shadow-xl border border-gray-200 rounded-2xl overflow-hidden">
        ...
        <div class="bg-gradient-to-r from-blue-600 to-blue-700 px-8 py-6">
            ...
            <p class="text-slate-300 text-sm mt-1">Pilih karyawan dan tentukan shift kerja untuk rencana ini</p>
        </div>
            ...
            <div class="p-8">
                <div class="mb-6">
                    ...
                    <select name="id_karyawan" id="search_karyawan" required
                            class="block w-full px-4 py-3 border border-gray-300 rounded-xl bg-gray-50 focus:ring-2 focus:ring-blue-500 transition outline-none font-medium">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                    <div>
                        ...
                        <input type="text" id="jk" readonly class="block w-full px-4 py-3 border border-gray-200 rounded-xl bg-gray-100 text-gray-500 cursor-not-allowed outline-none font-medium"/>
                    </div>
                    <div>
                        <label class="block text-sm font-bold text-gray-600 mb-2">Tanggal Aktif</label>
                        <input type="text" id="tgl_aktif" readonly class="block w-full px-4 py-3 border border-gray-200 rounded-xl bg-gray-100 text-gray-500 cursor-not-allowed outline-none font-medium"/>
                    </div>
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="number" name="upah_manual" id="upah_manual" required placeholder="0"
                                   class="block w-full pl-10 pr-4 py-3 border border-gray-300 rounded-xl bg-white focus:ring-2 focus:ring-blue-500 outline-none font-bold text-blue-600"/>
                        </div>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                    <div>
                        ...
                        <select name="id_jadwal" required class="block w-full px-4 py-3 border border-gray-300 rounded-xl bg-gray-50 focus:ring-2 focus:ring-blue-500 outline-none">
                    ...
                    <div>
                        ...
                        <select name="id_departmen" id="id_departmen" required class="block w-full px-4 py-3 border border-gray-300 rounded-xl bg-gray-50 focus:ring-2 focus:ring-blue-500 outline-none">
                    ...
                    <div>
                        ...
                        <select name="id_sub_department" id="id_sub_department" required class="block w-full px-4 py-3 border border-gray-300 rounded-xl bg-gray-50 focus:ring-2 focus:ring-blue-500 outline-none">
                ...
                <div class="flex items-center justify-between pt-6 border-t border-gray-100">
                    ...
                    <div class="flex gap-3">
                        <a href="?page=rkk&aksi=kelola&id=<?= $idrkk; ?>" class="px-5 py-2.5 border border-gray-300 shadow-sm text-sm font-bold rounded-xl text-gray-700 bg-white hover:bg-gray-50 transition">
                            Batal
                        </a>
                        <button type="submit" name="simpan_karyawan" class="inline-flex items-center px-6 py-2.5 border border-transparent text-sm font-bold rounded-xl shadow-md text-white bg-blue-600 hover:bg-blue-700 transition transform hover:-translate-y-0.5">
