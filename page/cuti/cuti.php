        ...
        <div class="card rounded-2xl shadow-sm border-0">
            <div class="card-header bg-white border-b border-gray-100 py-4 px-4 sm:px-6 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 sm:gap-0 rounded-t-2xl">
                ...
                <div class="card-tools w-full sm:w-auto">
                    <a href="?page=cuti&aksi=tambah" class="btn w-full sm:w-auto btn-primary bg-brand-600 hover:bg-brand-700 border-0 rounded-lg shadow-sm px-4 py-2 font-medium transition-colors flex justify-center items-center">
                            ...
                            <tr class="hover:bg-gray-50 transition-colors">
                                ...
                                <td data-label="Aksi" class="text-center align-middle">
                                    <div class="flex flex-wrap gap-2 justify-end sm:justify-center mt-2 sm:mt-0">
                                        <a href="?page=cuti&aksi=hapus&id=<?php echo $data['id_cuti'];?>" class="btn btn-sm bg-rose-500 hover:bg-rose-600 text-white border-0 shadow-sm rounded-md transition-colors" title="Batal Cuti">
