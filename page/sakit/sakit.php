    ...
    <div class="col-md-12">
        <div class="card rounded-2xl shadow-sm border-0">
            <div class="card-header bg-white border-b border-gray-100 py-4 px-4 sm:px-6 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 sm:gap-0 rounded-t-2xl">
                <h3 class="card-title text-xl font-bold text-gray-800 m-0">Data Karyawan Sakit / Ijin</h3>
                <div class="card-tools w-full sm:w-auto">
                    <a href="?page=sakit&aksi=tambah" class="btn w-full sm:w-auto btn-primary bg-brand-600 hover:bg-brand-700 border-0 rounded-lg shadow-sm px-4 py-2 font-medium transition-colors flex justify-center items-center">
                    ...
                    <table class="table table-hover table-striped border-b border-gray-100" id="dataTables-example" style="width:100%">
                        <thead class="bg-gray-50 text-gray-600 text-sm">
                            <tr>
                                ...
                                <th class="px-3 py-3 text-xs font-bold uppercase tracking-wider text-center">Dari Tgl</th>
                                <th class="px-3 py-3 text-xs font-bold uppercase tracking-wider text-center">Sampai Tgl</th>
                                <th class="px-3 py-3 text-xs font-bold uppercase tracking-wider text-center">Lama</th>
                                <th class="px-3 py-3 text-xs font-bold uppercase tracking-wider">Keterangan</th>
                                <th class="px-3 py-3 text-xs font-bold uppercase tracking-wider text-center" width="10%">Aksi</th>
                            </tr>
                        </thead>
                        <tbody class="divide-y divide-gray-100">
                            ...
                            <tr class="hover:bg-gray-50 transition-colors">
                                ...
                                <td data-label="Dari Tanggal" class="text-center text-sm text-gray-700"><?php echo date('d-m-Y', strtotime($data['tgl_awal'])); ?></td>
                                <td data-label="Sampai Tanggal" class="text-center text-sm text-gray-700"><?php echo date('d-m-Y', strtotime($data['tgl_akhir'])); ?></td>
                                <td data-label="Lama (Hari)" class="text-center text-sm font-medium text-brand-600"><?php echo $hari ?> Hari</td>
                                <td data-label="Keterangan" class="text-sm text-gray-700"><?php echo $data['keterangan'] ?></td>
                                <td data-label="Aksi" class="text-center align-middle">
                                    <div class="flex flex-wrap gap-2 justify-end sm:justify-center mt-2 sm:mt-0">
                                        <a href="?page=sakit&aksi=hapus&id=<?php echo $data['id_sia'];?>" class="btn btn-sm bg-rose-500 hover:bg-rose-600 text-white border-0 shadow-sm rounded-md transition-colors" title="Batal Data">
