    ...
    <div class="col-md-12">
        <div class="card rounded-2xl shadow-sm border-0">
            <div class="bg-white border-b border-gray-200 py-4 px-4 md:px-5 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                <div>
                    <h3 class="text-xl font-bold text-blue-600 m-0"><i class="fas fa-user-injured mr-2"></i>Data Karyawan Sakit</h3>
                    <p class="text-xs text-gray-500 mt-1">Kelola data ketidakhadiran karyawan berdasarkan periode</p>
                </div>
                <div class="w-full md:w-auto">
                    <a href="?page=sakit&aksi=tambah" class="flex justify-center items-center w-full md:w-auto bg-blue-600 hover:bg-blue-700 text-white px-5 py-2.5 rounded-lg shadow-sm font-bold text-sm transition-all">
