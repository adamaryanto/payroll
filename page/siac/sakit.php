...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-8">
    <div class="bg-white shadow-sm border border-gray-300 rounded-lg overflow-hidden">
        ...
        <div class="bg-teal-600 border-b border-teal-700 px-6 py-4">
                ...
                <table class="w-full border-collapse border border-gray-300" id="dataTables-example">
                    <thead class="bg-gray-100">
                        <tr>
                            ...
                            <th scope="col" class="border border-gray-300 px-4 py-3 text-left text-sm font-bold text-gray-900 uppercase tracking-wider">Keterangan</th>
                    ...
                    <tbody class="bg-white">
                        ...
                        <tr class="hover:bg-teal-50 transition-colors duration-200">
                            ...
                            <td class="border border-gray-300 px-4 py-3 text-sm font-semibold text-gray-800">
                                <?php echo htmlspecialchars($data['tgl_awal']); ?>
                            </td>
                            <td class="border border-gray-300 px-4 py-3 text-sm font-semibold text-gray-800">
                                <?php echo htmlspecialchars($data['tgl_akhir']); ?>
                            </td>
                            <td class="border border-gray-300 px-4 py-3 text-sm font-semibold text-gray-800 text-center">
                                <?php echo $hari; ?> Hari
                            </td>
...
<style>
    ...
    /* MODIFIKASI: Menambahkan margin untuk memberi jarak antar tombol */
    .dataTables_wrapper .dataTables_paginate .paginate_button {
        padding: 0.375rem 0.875rem !important;
        margin: 0 0.25rem !important; /* Jarak kiri-kanan sebesar 0.25rem (sekitar 4px) */
        border-radius: 0.375rem;
        ...
        cursor: pointer;
        transition: all 0.2s;
        display: inline-block; /* Memastikan margin diterapkan dengan benar */
    }
    ...
    .dataTables_wrapper .dataTables_paginate .paginate_button.current:hover {
        background: #0d9488 !important; /* warna teal Tailwind untuk match header */
...
if ($simpan) {
    echo "<script type='text/javascript'>window.location.href='?page=sakit&ttgl1=$ttgl1&ttgl2=$ttgl2';</script>";
}
if ($print) {
