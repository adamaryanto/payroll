...
<div class="row">
              ...
              <h3 class="box-title">Tambah Data Karyawan Cuti</h3>
            </div>
             <form method="POST"  enctype="multipart/form-data">
                 ...
                 <div class="form-group col-md-4">
                    ...
                    <input placeholder="*" autocomplete="off" type="text" name="tnama" value ="<?php echo $datanamakaryawan ; ?>" required class="form-control"/>
                     <a href="?page=cuti&aksi=cari&idkaryawan=<?php echo $datanamakaryawan ;?>"  class="btn btn-info">Cari </a> 
                </div>
 ...
 <div class="row" style=" background-color:white; border:1px ; color:black; "> 
                   <div class="form-group col-md-4">
                    <label class="font-weight-bold">Keterangan Cuti</label>
