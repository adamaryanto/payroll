...
$tampil = $koneksi->query("SELECT A.* , B.nama_karyawan , B.no_absen , B.jenis_kelamin FROM tb_ijin A LEFT JOIN ms_karyawan B on A.id_karyawan = B.id_karyawan where A.id_karyawan = '$id' ");
