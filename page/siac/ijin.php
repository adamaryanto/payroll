...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-8">
    <div class="bg-white shadow-sm border border-gray-300 rounded-lg overflow-hidden">
        ...
        <div class="bg-indigo-700 border-b border-indigo-800 px-6 py-4">
                ...
                <table class="w-full border-collapse border border-gray-300" id="dataTables-example">
                    <thead class="bg-gray-100">
                        <tr>
                            ...
                            <th scope="col" class="border border-gray-300 px-4 py-3 text-left text-sm font-bold text-gray-900 uppercase tracking-wider">Tanggal Ijin</th>
                            <th scope="col" class="border border-gray-300 px-4 py-3 text-left text-sm font-bold text-gray-900 uppercase tracking-wider">Jenis Ijin</th>
                            <th scope="col" class="border border-gray-300 px-4 py-3 text-left text-sm font-bold text-gray-900 uppercase tracking-wider">Keterangan Ijin</th>
                            <th scope="col" class="border border-gray-300 px-4 py-3 text-left text-sm font-bold text-gray-900 uppercase tracking-wider">Dari Jam</th>
                            <th scope="col" class="border border-gray-300 px-4 py-3 text-left text-sm font-bold text-gray-900 uppercase tracking-wider">Sampai Jam</th>
                    ...
                    <tbody class="bg-white">
                        ...
                        <tr class="hover:bg-indigo-50 transition-colors duration-200">
                            ...
                            <td class="border border-gray-300 px-4 py-3 text-sm font-semibold text-gray-800">
                                <?php echo htmlspecialchars($data['tgl_ijin']); ?>
                            </td>
                            <td class="border border-gray-300 px-4 py-3 text-sm font-semibold text-gray-800">
                                <?php echo htmlspecialchars($data['jenis_ijin']); ?>
                            </td>
                            <td class="border border-gray-300 px-4 py-3 text-sm font-semibold text-gray-800">
                                <?php echo htmlspecialchars($data['keterangan']); ?>
                            </td>
                            <td class="border border-gray-300 px-4 py-3 text-sm font-semibold text-gray-800 text-center">
                                <?php echo htmlspecialchars($data['waktu_awal']); ?>
                            </td>
                            <td class="border border-gray-300 px-4 py-3 text-sm font-semibold text-gray-800 text-center">
                                <?php echo htmlspecialchars($data['waktu_akhir']); ?>
                            </td>
                            <td class="border border-gray-300 px-4 py-3 text-center">
                                <a href="?page=ijin&aksi=hapus&id=<?php echo $data['id_ijin']; ?>" class="inline-flex items-center px-3 py-1.5 border border-transparent text-xs font-bold rounded shadow-sm text-white bg-red-600 hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 transition-colors" onclick="return confirm('Yakin ingin menghapus data ini?');">
...
if ($simpan) {
    echo "<script type='text/javascript'>window.location.href='?page=ijin&ttgl1=$ttgl1&ttgl2=$ttgl2';</script>";
}
if ($print) {
