...
$tampil = $koneksi->query("SELECT A.* , B.nama_karyawan , B.no_absen , B.jenis_kelamin FROM tb_cuti A LEFT JOIN ms_karyawan B on A.id_karyawan = B.id_karyawan where A.id_karyawan = '$id'");
...
<div class="row">
              ...
              <h3 class="box-title">Data Karyawan Cuti</h3>
            </div>
            ...
            <div class="row" style=" background-color:white; border:1px ; color:black; "> 
                 <div class="form-group col-md-6">
                     <a href="?page=siac"  class="btn btn-info">Back</a> 
                </div>
                </div>
...
<td>
    <a  href="?page=cuti&aksi=hapus&id=<?php echo $data['id_cuti'];?>"  class="btn btn-danger"> Hapus</a>
</td>
<!--
<td>
