        ...
        <div class="card rounded-2xl shadow-sm border-0 bg-white">
            <div class="bg-white border-b border-gray-200 py-4 px-4 md:px-5 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                ...
                <div class="w-full md:w-auto">
                    <a href="?page=ijin&aksi=tambah" class="flex justify-center items-center w-full md:w-auto bg-indigo-600 hover:bg-indigo-700 text-white px-5 py-2.5 rounded-lg shadow-sm font-bold text-sm transition-all">
