    ...
    <div class="bg-white shadow-xl border border-gray-200 rounded-2xl overflow-hidden">
        ...
        <div class="bg-gradient-to-r from-blue-600 to-blue-700 px-8 py-6">
            <h3 class="text-2xl font-extrabold text-white m-0 tracking-tight flex items-center">
                ...
                Tambah Data Karyawan Alfa
            </h3>
            <p class="text-rose-100 text-sm mt-1">Masukkan detail ketidakhadiran tanpa keterangan</p>
        </div>
        ...
        <form method="POST">
            <div class="p-8">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                    ...
                    <div class="md:col-span-2">
                        ...
                        ">
                            ...
                            while ($dkry = $sql_kry->fetch_assoc()) {
                                $selected = ($idkaryawan == $dkry['id_karyawan']) ? 'selected' : '';
                                echo "<option value='" . $dkry['id_karyawan'] . "' data-absen='" . $dkry['no_absen'] . "' $selected>" . $dkry['nama_karyawan'] . " (" . $dkry['no_absen'] . ")</option>";
                            }
                            ?>
                        </select>
                    </div>
                    ...
                    <div class="md:col-span-2">
                        <label class="block text-sm font-bold text-gray-700 mb-2">Keterangan Alfa <span class="text-rose-500">*</span></label>
                        <input type="text" name="tketerangan" required class="block w-full py-3 px-4 border border-gray-300 rounded-xl bg-gray-50 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition font-medium" placeholder="Masukkan keterangan..." />
                    </div>
                </div>
                ...
                <div class="flex items-center justify-between pt-6 border-t border-gray-100">
                    ...
                    <div class="flex gap-3">
                        <a href="?page=alfa" class="inline-flex items-center px-5 py-2.5 border border-gray-300 shadow-sm text-sm font-bold rounded-xl text-gray-700 bg-white hover:bg-gray-50 transition">
                            Batal
                        </a>
...
if (isset($_POST['simpan'])) {
    ...
    if ($sql) {
        echo '<script>alert("Data Alfa Tersimpan"); window.location.href="?page=alfa";</script>';
    }
}
?>