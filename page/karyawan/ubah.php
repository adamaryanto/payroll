...
if(isset($_GET['id'])){
    $idu = $_GET['id'];
$tampil=$koneksi->query("SELECT ms_karyawan.* , ms_sub_department.nama_sub_department , ms_sub_department.id_sub_department 
  from ms_karyawan 
...
<div class="row">
             ...
             <!-- Bagian has been moved to Rencana Upah input -->
