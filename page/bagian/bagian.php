    ...
    <div class="card-modern">
        <div class="card-modern-header">
            <h3 class="card-modern-title">
                <i class="fas fa-building" style="color:#2563eb;"></i> Data Bagian (Departemen)
            </h3>
            <a href="?page=bagian&aksi=tambah" class="btn-modern">
                ...
                <tbody>
                    ...
                    while ($data = $tampil->fetch_assoc()) : ?>
                        <tr class="hover:bg-blue-50 transition-colors duration-200">
                            ...
                            <td data-label="Nama Bagian"><strong><?php echo htmlspecialchars($data['nama_departmen']); ?></strong></td>
                            <td data-label="Aksi" class="text-center">
                                <a href="?page=bagian&aksi=ubah&id=<?php echo $data['id_departmen']; ?>" class="btn-action btn-edit" title="Edit">
    ...
    $(document).ready(function() {
        var table = $('#dataTables-example').DataTable({
            ...
            language: {
                ...
                info: "Menampilkan _START_ sd _END_ dari _TOTAL_ bagian"
            },
