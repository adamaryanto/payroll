            ...
            <div class="p-8">
                ...
                <div class="flex items-center justify-between pt-6 border-t border-gray-100">
                    ...
                    <div class="flex gap-3">
                        ...
                        <button type="submit" name="simpan" value="Simpan" class="inline-flex items-center px-6 py-2.5 border border-transparent text-sm font-bold rounded-xl shadow-md text-white bg-slate-700 hover:bg-slate-800 transition duration-150 ease-in-out transform hover:-translate-y-0.5">
