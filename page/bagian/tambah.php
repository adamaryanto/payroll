    ...
    <div class="col-md-6 col-md-offset-3">
        <div class="card rounded-2xl shadow-sm border-0">
            <div class="card-header bg-white border-b border-gray-100 py-4 rounded-t-2xl">
                <h3 class="card-title text-xl font-bold text-gray-800 m-0">Tambah Data Bagian</h3>
            </div>
            ...
            <form method="POST" enctype="multipart/form-data">
                <div class="card-body p-4">
                    <div class="form-group mb-4">
                        ...
                        <input placeholder="Masukkan nama bagian..." autocomplete="off" type="text" name="tnama" required class="form-control custom-input" />
                    </div>
                </div>
...
<style>
    ...
    /* Simple grid helpers if Tailwind is missing */
    .flex { display: flex; }
    .gap-3 { gap: 0.75rem; }
