...
<div class="row">
              ...
              <h3 class="box-title">Tambah Data Type Transaksi</h3>
            </div>
...
$simpan = @$_POST ['simpan'];
if($simpan) {
$sql = $koneksi->query("insert into tb_type_transaksi(type_transaksi) values('$tnama')  ");
if($sql) {
        ?>
                <script type="text/javascript">
                alert("Data Tersimpan");
                window.location.href="?page=typetransaksi";
