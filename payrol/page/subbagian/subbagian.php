...
<div class="row">
            ...
            <div class="row" style=" background-color:white; border:1px ; color:black; "> 
                 <div class="form-group col-md-6">
                      <a href="?page=subbagian&aksi=tambah"  class="btn btn-success">Tambah Data </a> 
                </div>
                </div>
...
$tampil = $koneksi->query("SELECT *  FROM ms_sub_department");
...
<a  href="?page=subbagian&aksi=ubah&id=<?php echo $data['id_sub_department'];?>"  class="btn btn-warning"> Ubah</a>
