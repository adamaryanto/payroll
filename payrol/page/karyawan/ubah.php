                ...
                <div class="form-group col-md-4">
                    <label class="font-weight-bold">Sub Bagian</label>
                     ...
                     <select class="form-control" name="tdepartmensub" required>
                      <option value="<?php echo $iddepartmensub; ?>"><?php echo $namadepartmensub; ?></option>
                                           <?php 
                   ...
                   <div class="form-group col-md-4">
                    ...
                    <input placeholder="*" autocomplete="off" type="text" name="tos" value="<?php echo $tos; ?>"  required class="form-control"/>
...
$sql = $koneksi->query("update ms_karyawan set  id_departmen ='$tdepartmen' , no_absen ='$tnoabsen' ,nama_karyawan = '$tnama',tempat_lahir = '$ttempatlahir' ,tgl_lahir = '$ttanggallahir',agama ='$tagama' ,status_kawin = '$tstatuskawin',jenis_kelamin = '$tjeniskelamin',no_ktp = '$tnoktp' ,no_sim = '$tnosim',alamat_ktp = '$talamatktp',alamat_tinggal = '$talamattinggal' , tgl_aktif = '$ttanggalbergabung',
  id_sub_department = '$tdepartmensub' , no_npwp = '$tnpwp' , no_bpjs = '$tbpjs',OS_DHK='$ttos',golongan='$tgolongan'
 where id_karyawan = '$idu'  ");
if($sql) {
        ?>
                <script type="text/javascript">
